            ...
            <div class="card card-primary card-outline">
              <div class="card-body box-profile">
                ...
                <ul class="list-group list-group-unbordered mb-3">
                  ...
                  <li class="list-group-item">
                    <b>Member</b> <a class="float-right">{{$user->created_at->format("d/m/Y")}}</a></a>
                  </li>
                </ul>
              ...
              <div class="card-body">
                <div class="tab-content">
                  ...
                  <div class="tab-pane" id="settings">
                    <form method="POST" action="{{route('users.update',$user)}}" enctype="multipart/form-data" class="form-horizontal">
                        @method("PUT")
                        @csrf
                      ...
                      <div class="form-group row">
                        <label for="email" class="col-sm-2 col-form-label">Email <span class="text text-danger h3" >*</span></label>
                        <div class="col-sm-10">
                      ...
                      <div class="form-group row">
                        <label for="phone" class="col-sm-2 col-form-label">Phone <span class="text text-danger h3" >*</span></label>
                        <div class="col-sm-10">
                      ...
                      <div class="form-group row">
                        <label for="current_password" class="col-sm-2 col-form-label">Current Password <span class="text text-danger h3" >*</span> </label>
                        <div class="col-sm-10">
                          <input type="text" name="current_password" class="form-control" id="current_password" placeholder="current_password">
                          @if (session('error'))
